...
class TritonPythonModel:
    def initialize(self, args):
        ...
        try:
            self.classifier = pipeline("text-classification", model="ahamedddd/showBranchesNLPDistilBertBaseUncasedv4", tokenizer="distilbert-base-uncased")
            ...
            try:
                ...
                for text in texts:
                    ...
                    if isinstance(result, list) and len(result) > 0:
                        ...
                        if best_pred['label'] == "LABEL_1":
                            best_pred['label'] = True
                        elif best_pred['label'] == "LABEL_0":
                            best_pred['label'] = False
                        else:
                            best_pred['label'] = False
